...
import com.tistory.whitepaek.restapiwithspring.common.RestDocsConfiguration;
...
public class EventControllerTests {
    ...
    public void createEvent_Bad_Request() throws Exception {
        Event event = Event.builder()
                ...
                .free(true)
                .offline(false)
                .eventStatus(EventStatus.PUBLICSHED)
                .build();
    ...
    public void createEvent_Bad_Request_Wrong_Input() throws Exception {
        EventDto eventDto = EventDto.builder()
                ...
                .closeEnrollmentDateTime(LocalDateTime.of(2020, 9, 20, 23, 59, 59))
                .beginEventDateTime(LocalDateTime.of(2020, 9, 8, 9, 00, 00))
                .endEventDateTime(LocalDateTime.of(2020, 9, 7, 21, 00, 00))
                .basePrice(10000)
                .maxPrice(200)
                .limitOfEnrollment(100)
                .location("디지털로 288 1708호 (주)비디").build();
    ...
    public void updateEvent_404() throws Exception {
        ...
        // When & Then
        this.mockMvc.perform(put("/api/events/19940915")
                .contentType(MediaType.APPLICATION_JSON)
                .content(this.objectMapper.writeValueAsString(eventDto)))
                .andDo(print())
                .andExpect(status().isNotFound());
